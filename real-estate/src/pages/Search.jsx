...
export default function Search() {
   ...
   // console.log (listings);
    ...
    const fetchListings = async() =>{
        ...
        fetchListings();
    },[location.search]);//if theres change in location.search we change the sidebar data
     //you can see the change is detected by useEffect and aldo filled in sidebar 
    ...
    const onShowMoreClick =async() =>{
        ...
        const urlParams = new URLSearchParams(location.search);
        urlParams.set('startIndex' , startIndex) //'startIndex' to our startIndex
        const searchQuery = urlParams.toString();
        const res = await fetch (`/api/listing/get?${searchQuery}`);
        const data = await res.json();
