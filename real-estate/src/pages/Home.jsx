  ...
  useEffect(()=>{
    ...
    const fetchOfferListings = async()=>{
      try {
        ...
        setOfferListings(data);//after this just fetch rentListings so that page will load things
        //until the above data isnt loaded the rent listing wont be fetched 
        fetchRentListings();
  ...
  return (
    <div>
      ...
      <div className= 'flex flex-col gap-6 p-28 px-3 max-w-7xl mx-auto'>
        ...
        Raghav Estate is the best online platform to find your next perfect space, designed for your lifestyle.
        <br/>
      ...
      <div className="max-w-8xl mx-auto p-3 flex flex-col gap-8 my-8">

        {// for offer listings only
          offerListings && offerListings.length > 0 && (
            <div className="mx-12">
              <div className="my-3">
