...
import {FaBath, FaBed, FaMapMarkerAlt, FaParking, FaShare  } from 'react-icons/fa';
      ...
      <main>
        ...
        {listing && !loading && !error && (
          <div>
            ...
            <div className="fixed top-[13%] right-[3%] z-10 rounded-full w-12 h-12 flex justify-center items-center bg bg-slate-100 cursor-pointer">
              <FaShare 
              ...
              <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                ...
                <div className="flex gap-4">
                   ...
                   {
                     listing.offer && (
                      <p className="bg-green-900 w-full m-w-[200px] text-white text-center p-1 rounded-md" >
                  ...
                  <ul className=" text-green-900 font-semibold text-sm flex items-center gap-4 sm:gap-6 flex-wrap" >
                    ...
                    <li className="flex items-center gap-1 whitespace-nowrap " >
                      ...
                      {listing.bath > 1 ? `${listing.bathrooms}baths` : `${listing.bathrooms}bath`}
                    </li>
                    <li className="flex items-center gap-1 whitespace-nowrap " >
